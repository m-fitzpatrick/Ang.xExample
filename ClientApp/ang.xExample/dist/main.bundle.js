...
var ApplicationService = (function () {
    function ApplicationService() {
        ...
        this.getRequestOptions = function () {
            ...
            requestOptions.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Headers */]({ 'Content-Type': 'application/json' });
    ...
    Object.defineProperty(ApplicationService.prototype, "currentUser", {
        get: function () {
...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        var _this = this;
        return this.http.post(this.appService.commonValues.baseUrl + 'api/account/login', JSON.stringify({ username: username, password: password }), this.appService.requestOptions)
            .map(function (response) {
            // login successful if there's a token in the response
            var user = response.json();
            if (user && user.token) {
                // store user details and token in local storage to keep user logged in between page refreshes
                _this.appService.currentUser = user;
            }
        });
    };
...
var AppComponent = (function () {
    function AppComponent(router, appService, authenticationService) {
        this.router = router;
        this.appService = appService;
        this.authenticationService = authenticationService;
        this.title = 'a Login Example';
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__Services_app_service__["a" /* ApplicationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__Services_app_service__["a" /* ApplicationService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__Services_authentication_service__["a" /* AuthenticationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__Services_authentication_service__["a" /* AuthenticationService */]) === "function" && _c || Object])
], AppComponent);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__Services_app_service__["a" /* ApplicationService */]
        ],
...
// module
exports.push([module.i, "p.home span {\r\n    display: inline-block;\r\n    padding: 5px;\r\n    background-color: yellow;\r\n    border: black solid 1px;\r\n}", ""]);
...
var HomeComponent = (function () {
    function HomeComponent(applicationService) {
        ...
        var currentUser = applicationService.currentUser;
        if (currentUser) {
...
HomeComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__Services_app_service__["a" /* ApplicationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__Services_app_service__["a" /* ApplicationService */]) === "function" && _a || Object])
], HomeComponent);
...
// module
exports.push([module.i, "div.login {\r\n    padding: 30px;\r\n}", ""]);
